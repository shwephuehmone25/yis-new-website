...
function Campuses({ onAction }) {
  return <Section id="campuses" narrow><SectionHeading title="Our Campuses">Serving key regions in Myanmar with dedicated faculty, modern infrastructure, and vibrant student communities.</SectionHeading><div className={styles.campusGrid}>
    <CampusCard name="Mandalay" href="/mandalay" image="/mandalay.png" description="Our Mandalay campus offers a state-of-the-art facility with world-class teachers dedicated to academic excellence and holistic development." onAction={onAction} />
...
function Accreditations() {
  return <section className={styles.affiliations} id="community"><Container><h2>Affiliations &amp; Accreditations</h2><div className={styles.affiliationGrid}>{partners.map(partner => <AccreditationBadge key={partner.acronym} {...partner} />)}</div></Container></section>;
}
