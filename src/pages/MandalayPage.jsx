...
const events = [
  ["Feb. 3", "100th Day of School Celebration"],
  ["Feb. 6", "Grade 6 Field Trip – National Museum"],
  ["Feb. 11", "KG Chinese New Year Festival"],
  ["Feb. 15", "ES Arts & Crafts Showcase"],
  ["Mar. 3", "Elementary Science Fair"],
];
...
function Hero() {
  return (
    <section className={styles.hero} aria-labelledby="mandalay-title">
      <img
...
function AtAGlance() {
  const items = [
    ...
    [
      Star,
      "Our core values",
      "Academically well-prepared · Culturally sensitive · Socially responsible · Personally fulfilled",
    ],
    [
      Users,
      "Average class sizes",
  ...
  return (
    <section className={styles.glance}>
      <Container narrow>
        <Heading>YIS at a glance</Heading>
        ...
        <div className={styles.aboutGrid}>
          <div className={styles.aboutImage}>
            <img
              ...
              alt="Students learning at YIS Mandalay"
              loading="lazy"
            />
            <b>
              500+<small>students</small>
            </b>
          </div>
          <div>
            <Heading eyebrow="About the campus">Who we are</Heading>
            <p>
              YIS Mandalay is part of the Yangon International School group,
              founded in 2004. Our Mandalay campus was established to bring the
              same world-class education to the cultural capital of Myanmar,
              enrolling children aged 3–18.
            </p>
            <p>
              Our graduates go on to attend top universities around the world.
              The United States, Canada, United Kingdom, Australia, Singapore,
...
function Programs({ onAction }) {
  return (
    <section className={styles.programs}>
      <Container narrow>
        <Heading eyebrow="Curriculum" light>
          Academic programs
        </Heading>
...
function Connections() {
  return (
    <section className={styles.connections}>
      <Container narrow>
        <Heading>Our connections</Heading>
        <div>
          {partners.map((p) => (
            <AccreditationBadge key={p.acronym} {...p} />
          ))}
        </div>
      </Container>
    </section>
    ...
    <section id="tour" className={styles.tour}>
      <Container narrow>
        <div className={styles.tourGrid}>
          <div>
            <Heading eyebrow="Visit us">Book a tour</Heading>
            <p>
              We invite you to visit our Mandalay campus and see first-hand what
              makes YIS a wonderful place for your child to grow and develop
              into a leader of tomorrow.
            </p>
            <p>
...
function Events() {
  return (
    <section className={styles.events}>
      <Container narrow>
        <Heading eyebrow="Calendar">Schoolwide events</Heading>
        <p className={styles.notice}>
          No upcoming all-school events are scheduled at this time. Please check
          back soon or contact the campus office.
        </p>
        <h3>What's happening at YIS?</h3>
